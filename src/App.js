...
const App = () => {
  ...
  useEffect(() => {
    ...
    gsap.from('.shadowDesktop, .desktop, .box', {
      x:-600,
    });

    gsap.to('.shadowDesktop, .desktop, .box', {
      duration: 4,
      x:0,
      yoyo: true,
    });
    ...
    gsap.from('.shadowMobile, .mobile', {
      x:600,
    });

    gsap.to('.shadowMobile, .mobile', {
      duration: 4,
      x:0,
      yoyo: true,
    });

    tl.to('.shadowMobile, .mobile', {
      y:5,
      repeat:-1,
      yoyo:true,
      duration:3,
    ...
    <div className="pt-5 mt-5">
      <div className="card mt-5 pt-5 pt-md-1">
        ...
        <div className="text pt-md-0 pt-5 pt-lg-5 mt-lg-3 ">
          <h4 className="center faq">FAQ</h4>
